    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="pt-20 pb-12 px-4">
        <div className="max-w-5xl mx-auto pt-8 grid gap-10 lg:grid-cols-[2fr,1.5fr]">
          ...
          <div>
            <p className="text-xs font-medium text-[#FFC727] uppercase tracking-wide mb-2">
              {course.niveau}
            </p>
            ...
            <div className="grid gap-3 sm:grid-cols-3 mb-8">
              <div className="rounded-xl border border-gray-700 bg-gray-900 p-4">
                <p className="text-sm font-semibold text-white">100% en ligne</p>
                <p className="text-xs text-gray-400 mt-1">
                  Accès 24/7, avancez à votre rythme.
                </p>
              </div>
              <div className="rounded-xl border border-gray-700 bg-gray-900 p-4">
                <p className="text-sm font-semibold text-white">Accompagnement</p>
                <p className="text-xs text-gray-400 mt-1">
                  Suivi pédagogique et évaluations régulières.
                </p>
              </div>
              <div className="rounded-xl border border-gray-700 bg-gray-900 p-4">
                <p className="text-sm font-semibold text-white">Certification RNCP</p>
                <p className="text-xs text-gray-400 mt-1">
            ...
            <div className="space-y-8">
              ...
              <section>
                <h2 className="text-xl font-semibold mb-2">Ce que vous allez apprendre</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold mb-2">Programme (exemple de modules)</h2>
                <div className="rounded-xl border border-gray-700 bg-gray-900 p-4">
              ...
              <section>
                <h2 className="text-xl font-semibold mb-2">Public & prérequis</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold mb-2">Modalités</h2>
                <p className="text-gray-300 text-sm">
              ...
              <section>
                <h2 className="text-xl font-semibold mb-2">Financement</h2>
                <div className="rounded-xl border border-gray-700 bg-gray-900 p-4 text-sm text-gray-300 space-y-2">
              ...
              <section>
                ...
                <div className="space-y-3">
                  <div className="rounded-xl border border-gray-700 bg-gray-900 p-4">
                    <p className="font-semibold text-white text-sm">Combien de temps dure la formation ?</p>
                    <p className="text-sm text-gray-400 mt-1">
                      Vous avancez à votre rythme. Une estimation et un planning peuvent être proposés à l’inscription.
                    </p>
                  </div>
                  <div className="rounded-xl border border-gray-700 bg-gray-900 p-4">
                    <p className="font-semibold text-white text-sm">Y a-t-il un suivi ?</p>
                    <p className="text-sm text-gray-400 mt-1">
                      Oui : accompagnement, évaluations, et préparation à l’examen RNCP.
                    </p>
                  </div>
                  <div className="rounded-xl border border-gray-700 bg-gray-900 p-4">
                    <p className="font-semibold text-white text-sm">Puis-je commencer rapidement ?</p>
                    <p className="text-sm text-gray-400 mt-1">
              ...
              <div className="mt-2 flex flex-wrap gap-3">
                <Link
                  to="/e-learning"
                  className="inline-flex items-center justify-center px-4 py-2 rounded-lg border border-gray-600 text-sm text-gray-200 hover:bg-gray-800"
                >
                  ← Retour aux cours
                </Link>
                <Link
                  to=""
                  className="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-[#FFC727] text-black text-sm font-semibold hover:bg-[#FFC727]/90"
                >
          ...
          <aside className="space-y-4">
            ...
            <div className="rounded-xl border border-gray-700 bg-gray-900 p-4 text-sm text-gray-300 space-y-3">
            ...
            <div className="rounded-xl border border-gray-700 bg-gray-900 p-4">
              <p className="text-sm font-semibold text-white">Pourquoi choisir Horizon ?</p>
