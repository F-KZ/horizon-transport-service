...
const Profession = ({ switchSide}) => {
  return(
    <div className="flex flex-col gap-5 max-w-3xl  ">
              ...
              <p data-aos="fade-up" className="text-justify leading-8 tracking-wide text-2xl lg:text-lg ">
              ...
              <Link to="/formules">
              <button
               data-aos="fade-up" className="button-outline text-2xl lg:text-lg">
                Je suis intéressé !
                </button>
              </Link>
            </div>
...
const Formation = () => {
  return(
    <div className="space-y-5">
              <h1
                data-aos="fade-up"
                className="text-2xl lg:text-lg font-bold font-serif"
              >
...
const About = () => {
  ...
  return (
    <div className="dark:bg-dark bg-slate-100 sm:min-h-[400px] sm:grid sm:place-items-center duration-300">
      <div className="container pt-16 xl:pt-4 pb-4 px-0">
